      ...
      activityForm.value.validate((valid: any): boolean => {
        if (valid) {
          ...
          let record = {
            ...
            reason: sizeForm.leave_reason,
            start_date: sizeForm.leave_start_time1 + " " + sizeForm.leave_start_time2,
            end_date: sizeForm.leave_end_time1 + " " + sizeForm.leave_end_time2,
            submitted_at: formattedDate,
            status: '未审核',
            review_user_id: sizeForm.notified_user,
            cc_user: sizeForm.cc_user, // 传递抄送人数组
            type: sizeForm.leave_type,
          }
